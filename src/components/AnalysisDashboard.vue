...
const activeTab = ref<'issues' | 'timeline'>('issues')
...
const canViewTimeline = computed(() => filterArea.value !== 'all')
const timelineTooltip = computed(() => (canViewTimeline.value ? '' : 'Select module to view timeline'))
...
function selectTab(tab: 'issues' | 'timeline') {
  if (tab === 'timeline' && !canViewTimeline.value) {
    return
  }
  ...
  <div>
    <div class="flex items-center gap-3 mb-6">
      <button
        ...
        :class="[
          ...
          activeTab === 'issues'
            ...
            : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50 hover:border-gray-400 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-500'
        ]"
      >
        Issues
      </button>
      <button
        ...
        :aria-disabled="!canViewTimeline"
        :title="timelineTooltip"
        @click="selectTab('timeline')"
        :class="[
          'rounded-full border px-4 py-2 text-sm font-medium transition-all',
          canViewTimeline ? 'cursor-pointer' : 'cursor-not-allowed',
          !canViewTimeline ? 'opacity-60' : '',
          activeTab === 'timeline'
            ? 'bg-blue-600 text-white border-blue-600 shadow-sm dark:bg-blue-500 dark:border-blue-500'
            : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50 hover:border-gray-400 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-500'
        ]"
