  ...
  <div class="border-t border-gray-200 bg-gray-50 px-4 py-4">
    ...
    <div class="space-y-2 max-h-80 overflow-y-auto">
      ...
      >
        ...
        <pre class="text-xs text-gray-800 whitespace-pre-wrap font-mono leading-relaxed overflow-x-auto">{{ entry.message }}</pre>
      </div>
      <p v-if="issue.entries.length > 10" class="text-xs text-gray-500 text-center pt-2">
