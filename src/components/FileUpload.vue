...
<template>
  <div class="max-w-xl mx-auto">
    <div class="text-center mb-8">
      <h2 class="text-2xl font-bold text-gray-900 mb-2">Analyze PowerToys Logs</h2>
    ...
    >
      <div v-if="isLoading" class="flex flex-col items-center gap-3">
        ...
        <p class="text-gray-600 font-medium">Analyzing logs...</p>
      </div>
      <div v-else class="flex flex-col items-center gap-3">
        ...
        <div>
          <p class="text-gray-700 font-medium">Drop your PowerToys zip file here</p>
